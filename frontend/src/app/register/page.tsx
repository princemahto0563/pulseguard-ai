    ...
    <div className="auth-root">
      ...
      <div className={`auth-card ${mounted ? "auth-card-in" : ""}`}>
        ...
        <div className="auth-header">
          ...
          <p className="auth-sub">Deploy intelligent endpoint monitoring</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="strength-row">
            ...
            <div className="strength-bar"><div className="strength-fill" style={{background:'rgba(255,255,255,0.08)'}} /></div>
            <div className="strength-bar"><div className="strength-fill" style={{background:'rgba(255,255,255,0.08)'}} /></div>
          </div>
        ...
        <div className="auth-footer-link">
          ...
          <Link href="/login" className="link-cta">Login here</Link>
        </div>
      </div>
